...
public class StashConnectImpl implements StashConnect {
    ...
    public String getSomething(String something) throws ResponseException {
        StashResponseHandler temp = executeRequest(something);
    ...
    public ApplicationLink getStashApplicationLink()
